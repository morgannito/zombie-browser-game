...
class AccountProgression {
  ...
  constructor({
    ...
    if (accountLevel < 1) throw new Error('accountLevel must be >= 1');
    if (accountXP < 0) throw new Error('accountXP must be >= 0');
    if (totalXPEarned < 0) throw new Error('totalXPEarned must be >= 0');
    if (skillPoints < 0) throw new Error('skillPoints must be >= 0');
    if (prestigeLevel < 0) throw new Error('prestigeLevel must be >= 0');
    if (prestigeTokens < 0) throw new Error('prestigeTokens must be >= 0');
    /** @type {string} */
