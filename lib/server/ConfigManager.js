...
// LOW FIX: Gameplay constants (extracted magic numbers)
const GAMEPLAY_CONSTANTS = {
  GAME_LOOP_TIMEOUT: 5000, // Game loop stuck detection timeout (ms)
  COMBO_TIMEOUT: 5000, // Combo reset timeout (ms)
  REGENERATION_TICK_INTERVAL: 1000, // Player regen tick interval (ms)
  AUTO_TURRET_BASE_COOLDOWN: 600, // Base auto-turret cooldown (ms)
  AUTO_TURRET_RANGE: 500, // Auto-turret detection range
  SLOW_FRAME_WARNING_THRESHOLD: 100, // Frame time warning threshold (ms)
  FAILED_DEATH_QUEUE_MAX_SIZE: 100, // Max failed death queue size
  SURVIVAL_TIME_MULTIPLIER: 1000 // Survival time conversion (ms to seconds)
};
