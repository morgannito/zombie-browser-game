...
class ZombieManager {
  ...
  spawnSingleZombie() {
    ...
    if (attempts >= 50) {
      ...
      console.warn('[ZOMBIE SPAWN] Failed to find valid spawn position after 50 attempts (wave', this.gameState.wave, ')');
    ...
    if (this.gameState.wave <= 2) {
      ...
      types = ['normal', 'fast', 'fast', 'tank', 'tank', 'healer', 'slower', 'slower', 'poison', 'poison', 'shooter', 'shooter', 'teleporter', 'teleporter', 'summoner', 'shielded', 'berserker', 'berserker'];
    } else {
      types = ['fast', 'fast', 'tank', 'tank', 'tank', 'healer', 'healer', 'slower', 'slower', 'poison', 'poison', 'shooter', 'shooter', 'shooter', 'teleporter', 'teleporter', 'summoner', 'summoner', 'shielded', 'shielded', 'berserker', 'berserker', 'berserker'];
    }
