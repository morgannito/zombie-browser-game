...
class ZombieManager {
  ...
  spawnSingleZombie() {
    ...
    // Utiliser le spawn manager intelligent pour sélectionner le type
  ...
  /**
   * Spawner un zombie spécifique à une position donnée
   * @param {string} typeKey - Type de zombie à spawner
