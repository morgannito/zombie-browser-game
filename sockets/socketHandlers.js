...
// Nickname handler moved to transport/websocket/handlers/setNickname.js
const { registerSetNicknameHandler } = require('../transport/websocket/handlers/setNickname');
