...
describe('MetricsCollector — histogram support', () => {
  ...
  beforeEach(() => {
    jest.resetModules();
    const mod = require('../../../../lib/infrastructure/MetricsCollector');
    mc = mod.getInstance();
    mc.reset();
  });
...
describe('/metrics/game — buildGameStats', () => {
  test('test_buildGameStats_returns_expected_shape', () => {
    jest.resetModules();
    const { buildGameStats } = require('../../../../routes/metrics');
    const mc = require('../../../../lib/infrastructure/MetricsCollector').getInstance();
    mc.reset();
...
describe('/admin/stats — buildAdminStats', () => {
  test('test_buildAdminStats_returns_expected_shape', () => {
    jest.resetModules();
    const { buildAdminStats } = require('../../../../routes/adminStats');
    const mc = require('../../../../lib/infrastructure/MetricsCollector').getInstance();
    mc.reset();
