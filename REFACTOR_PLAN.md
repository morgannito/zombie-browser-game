...
- [x] player context 33% → 75.85% (DeathProgressionHandler 82% + AutoTurretHandler 100% + TeslaCoilHandler 100% — 68 tests via 3 parallel agents PR #112/#113/#114). Threshold ratchet 33→70%.
